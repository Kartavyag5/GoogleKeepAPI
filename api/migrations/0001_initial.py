    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('User', models.ForeignKey(default='1', on_delete=django.db.models.deletion.CASCADE, related_name='Task_lists', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Note',
            fields=[
                ...
                ('Background_color', models.CharField(blank=True, choices=[('white', 'White'), ('red', 'Red'), ('orange', 'Orange'), ('yellow', 'Yellow'), ('green', 'Green'), ('blue', 'Blue'), ('purple', 'Purple'), ('black', 'Black')], default='white', max_length=20)),
                ('Description', models.TextField(blank=True)),
                ('Reminder', models.DateTimeField(blank=True, default=None, null=True)),
                ('Created_at', models.DateTimeField(auto_now_add=True)),
                ('Updated_at', models.DateTimeField(auto_now=True)),
                ('ImageList', models.ForeignKey(blank=True, default=None, on_delete=django.db.models.deletion.CASCADE, to='api.imagelist')),
                ('List', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='api.list')),
